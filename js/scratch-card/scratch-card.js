...
function scratchCard42(imgPrinc,imgScrateched,imgWidth,imgHeight){
  'use strict';
  if(imgPrinc && imgScrateched){
    var isDrawing, lastPoint;
    var container    = document.getElementById('js-container-42'),
        setImgWidth  = imgWidth ? imgWidth : container.clientWidth,
        setImgHeight = imgHeight ? imgHeight : container.clientWidth,
        discountIMG  = document.getElementById("discountIMG-42"),
        canvas       = document.getElementById('js-canvas-42'),
        canvasWidth  = canvas.width,
        canvasHeight = canvas.height,
        ctx          = canvas.getContext('2d'),
        image        = new Image(),
    ...
    image.onload = function() {
      ctx.drawImage(image, 0, 0,setImgWidth,setImgHeight);
      document.querySelectorAll('.discount-42')[0].style.visibility = 'visible';
    };
    brush.src = 'data:image/png;base64,';
    canvas.addEventListener('mousedown', handleMouseDown, false);
    canvas.addEventListener('touchstart', handleMouseDown, false);
